...
export const paymentVerification = catchAsyncError(async(req,res,next) => {
    ...
    // console.log("razorpay_signature=",razorpay_signature,"razorpay_payment_id=", razorpay_payment_id,"razorpay_subscription_id=", razorpay_subscription_id);
    const user = await User.findById(req.user._id);
    ...
    // const generated_signature = crypto.createHmac("sha256",process.env.RAZORPAY_API_SECRET)
    // .update(razorpay_subscription_id+"|"+razorpay_payment_id,"utf-8").digest("hex");

    // const isAuthentic = generated_signature===razorpay_signature;
    // generated_signature = hmac_sha256(razorpay_subscription_id + "|" + razorpay_payment_id, secret);
